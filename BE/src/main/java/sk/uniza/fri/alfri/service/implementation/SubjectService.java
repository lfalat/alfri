...
import sk.uniza.fri.alfri.repository.StudyProgramSubjectSpringDataRepository;
...
public class SubjectService implements ISubjectService {
  ...
  @Override
  public Page<StudyProgramSubject> findAllByStudyProgramId(SearchDefinition searchDefinition, PageDefinition pageDefinition) {
