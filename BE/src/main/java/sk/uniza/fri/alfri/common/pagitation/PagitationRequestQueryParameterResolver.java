...
public class PagitationRequestQueryParameterResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter,
        ...
        String pageStr = webRequest.getParameter(getParameterNameToUse(DEFAULT_PAGE_PARAMETER, parameter));
        String sizeStr = webRequest.getParameter(getParameterNameToUse(DEFAULT_SIZE_PARAMETER, parameter));
        String searchStr = webRequest.getParameter(getParameterNameToUse(DEFAULT_SEARCH_PARAMETER, parameter));
